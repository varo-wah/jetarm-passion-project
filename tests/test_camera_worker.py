...
class CameraWorkerTests(unittest.TestCase):
    def test_v4l2_defaults_are_parsed(self):
        ...
        white_balance_automatic 0x0098090c (bool) : default=1 value=0
                    pan_absolute 0x009a0908 (int) : min=-36000 max=36000 default=0 value=100
        """
    ...
    def test_only_image_controls_reset_to_driver_defaults(self, run, _which):
        run.side_effect = [
            subprocess.CompletedProcess(
                args=[],
                returncode=0,
                stdout=(
                    "brightness 0x00980900 (int) : default=0 value=12\n"
                    "gamma 0x00980910 (int) : default=100 value=140\n"
                    "gain 0x00980913 (int) : default=0 value=20\n"
        ...
        self.assertFalse(
            any("pan_absolute" in part for command in commands for part in command)
        )
