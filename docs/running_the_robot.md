...
to the V4L2 driver's declared defaults. Raw, OpenCV, and YOLO views use that
natural frame directly; no display gamma or saturation enhancement is applied.
The ROS `usb_cam_param.yaml` does not configure this OpenCV capture path.
