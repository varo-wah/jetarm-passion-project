...
# SETTINGS (EDIT THESE)
# =========================
from jetarm.config.sorting_config import BLUE_BIN, GREEN_BIN, NEUTRAL_BIN, RED_BIN

NEUTRAL_BUCKET_X, NEUTRAL_BUCKET_Y = NEUTRAL_BIN
RED_BUCKET_X, RED_BUCKET_Y = RED_BIN
BLUE_BUCKET_X, BLUE_BUCKET_Y = BLUE_BIN
GREEN_BUCKET_X, GREEN_BUCKET_Y = GREEN_BIN
APPROACH_Z = 7.0
